...
|--------|----------|-------------|--------|
| ROC-AUC | 0.8289 | 0.8289 | ≥ 0.80 ✅ |
| Accuracy | 79.8% | 79.8% | ≥ 80% ⚠️ |
| Churn Recall | 56.4% | 55.6% | ≥ 75% ❌ |
| Churn Precision | 63.6% | 63.6% | — |
...
::: {.column width="45%"}
### Why 0.30?
At threshold = 0.30 the model catches **~79% of actual churners** ✅
...
|---------|------------|
| MonthlyCharges | +0.89 |
| InternetService_fiber_optic | +1.07 |
| TotalCharges | +0.67 |
...
|---------|------------|
| tenure | -1.40 |
| Contract_two_year | -1.54 |
| Contract_one_year | -0.69 |
| InternetService_no | -0.87 |
:::
:::
...
- At threshold 0.30, churn recall reaches **~79%**, meeting the project target
- **tenure** and **MonthlyCharges** are the two dominant predictors
- Contract type is the strongest categorical signal: the two-year customers churn at just **2.8%** vs **42.7%** for month-to-month
:::
::: {.column width="45%"}
